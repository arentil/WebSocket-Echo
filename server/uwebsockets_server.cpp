    ...
    uWS::App(
      ...
      .ws<PerSocketData>("/*",
                         {/* Settings */
                          ...
                          {
                              /* This is the opposite of what you probably want; compress if message
                               * is LARGER than 16 kb the reason we do the opposite here; compress
                               * if SMALLER than 16 kb is to allow for benchmarking of large message
